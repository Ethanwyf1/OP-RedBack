...
stage_names = ["Home", "Preprocessing", "PRELIM", "SIFTED", "PILOT", "CLOISTER", "PYTHIA", "TRACE", "Cache"]
...
# 3. Sidebar selection
selected_stage = st.sidebar.radio("Select Stage", stage_names, index=stage_names.index(default_stage))
